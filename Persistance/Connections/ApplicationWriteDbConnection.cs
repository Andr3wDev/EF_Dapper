...
namespace Persistance.Connections
{
    public class ApplicationWriteDbConnection : IApplicationWriteDbConnection
    {
        ...
        public async Task<T> QueryFirstOrDefaultAsync<T>(
            ...
            CancellationToken cancellationToken = default)
        {
            return await context.Connection.QueryFirstOrDefaultAsync<T>(
        ...
        public async Task<T> QuerySingleAsync<T>(
            ...
            CancellationToken cancellationToken = default)
        {
            return await context.Connection.QuerySingleAsync<T>(
                sql, param, transaction);
        }
    }
}
